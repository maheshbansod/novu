...
export type NotificationClickHandler = (args: {
    notification: Notification;
}) => void;
export type NotificationActionClickHandler = (args: {
    notification: Notification;
}) => void;
export type NotificationMounter = (el: HTMLDivElement, options: {
    notification: Notification;
}) => () => void;
export type BellMounter = (el: HTMLDivElement, options: {
    unreadCount: number;
}) => () => void;
export type Tab = {
    label: string;
