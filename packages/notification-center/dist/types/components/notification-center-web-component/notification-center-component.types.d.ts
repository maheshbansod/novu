...
type SelectedProviderProps = Pick<INovuProviderProps, 'onLoad' | 'stores' | 'backendUrl' | 'socketUrl' | 'subscriberId' | 'applicationIdentifier' | 'subscriberHash' | 'i18n'>;
...
type SelectedPopoverProps = Pick<IPopoverNotificationCenterProps, 'onUnseenCountChanged' | 'onActionClick' | 'onTabClick' | 'theme' | 'tabs' | 'showUserPreferences' | 'allowedNotificationActions' | 'preferenceFilter'> & {
    popoverConfig?: {
...
export type NotificationCenterComponentProps = NovuProviderProps & PopoverWrapperProps & {
