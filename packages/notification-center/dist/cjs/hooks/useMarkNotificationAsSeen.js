...
exports.useMarkNotificationsAsSeen = void 0;
...
const useMarkNotificationsAsSeen = (_a = {}) => {
    ...
    const _b = (0, react_query_1.useMutation)(({ feedId }) => apiService.markAllMessagesAsSeen(feedId), Object.assign(Object.assign({}, options), { onSuccess: (responseData, variables, context) => {
...
exports.useMarkNotificationsAsSeen = useMarkNotificationsAsSeen;
//# sourceMappingURL=useMarkNotificationAsSeen.js.map