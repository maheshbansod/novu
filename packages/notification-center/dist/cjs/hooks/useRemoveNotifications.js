...
exports.useRemoveNotifications = void 0;
...
const useRemoveNotifications = (_a = {}) => {
    ...
    const _b = (0, react_query_1.useMutation)(({ messageIds }) => apiService.removeMessages(messageIds), Object.assign(Object.assign({}, options), { onSuccess: (data, variables, context) => {
...
exports.useRemoveNotifications = useRemoveNotifications;
