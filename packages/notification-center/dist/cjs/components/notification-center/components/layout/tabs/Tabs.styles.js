...
exports.default = (0, core_1.createStyles)((theme, { novuTheme, common, colorScheme }, getRef) => {
    ...
    return {
        tabsList: {
            ...
            padding: '15px',
            paddingBottom: 0,
            borderBottom: `1px solid ${colorScheme === 'dark' ? colors_1.colors.B20 : colors_1.colors.B98}`,
        },
        tab: {
            display: 'block',
            cursor: 'pointer',
            ...
            [`.mantine-Badge-root`]: {
                ...
                border: `1px solid ${colors_1.colors.B60}`,
                color: colors_1.colors.B60,
            },
            '&:hover': {
                background: 'none',
                [`& .${tabIcon}`]: {
