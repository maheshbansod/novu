...
function mapChildren(node) {
    ...
    const arr = Array.from(node.childNodes).map((el) => {
        ...
        return react_1.default.createElement(nodeName, attributes, children);
    });
    return flattenIfOne(arr);
}
let updateTimeout = null;
const moveUpdateToNextTick = (fn) => {
    if (updateTimeout) {
...
const define = {
    ...
    expand: function (receiver, key, value) {
...
function default_1(ReactComponent, options = {}) {
    if (isSSR) {
        return;
    }
    ...
    targetPrototype.disconnectedCallback = function () {
        // @ts-expect-error
        if (typeof react_dom_1.default.createRoot === 'function') {
    ...
    targetPrototype[renderSymbol] = function () {
        if (this[shouldRenderSymbol] === true) {
            ...
            const element = react_1.default.createElement(ReactComponent, data, children);
            // Use react to render element in container
            // @ts-expect-error
            if (typeof react_dom_1.default.createRoot === 'function') {
                if (!this[rootSymbol]) {
                    // @ts-expect-error
                    this[rootSymbol] = react_dom_1.default.createRoot(container);
                }
        ...
        switch (propTypes[propertyName]) {
            ...
            case Function:
                if (!newValue && propTypes[propertyName] === 'ref') {
                    newValue = react_1.default.createRef();
                    break;
                }
...
//# sourceMappingURL=react-to-webcomponent.js.map