...
import { GetOrganizationMembershipListParams, Organization, UpdateOrganizationParams, UpdateMetadataParams } from './clerk.organization.types';
import { UpdateUserParams, User, UserListParams, GetUserOrganizationMembershipListParams, UserMetadataParams } from './clerk.user.types';
export interface IUserAPI {
    ...
    getOrganizationMembershipList(params: GetUserOrganizationMembershipListParams): Promise<PaginatedResourceResponse<OrganizationMembership[]>>;
}
...
export {};
//# sourceMappingURL=clerk.types.d.ts.map