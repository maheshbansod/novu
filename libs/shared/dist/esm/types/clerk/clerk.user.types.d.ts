...
export type UserListParams = ClerkPaginationRequest<UserCountParams & {
    orderBy?: WithSign<'createdAt' | 'updatedAt' | 'emailAddress' | 'web3wallet' | 'firstName' | 'lastName' | 'phoneNumber' | 'userName' | 'lastActiveAt' | 'lastSignInAt'>;
...
export {};
//# sourceMappingURL=clerk.user.types.d.ts.map