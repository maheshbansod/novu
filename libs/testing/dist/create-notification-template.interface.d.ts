import { IEmailBlock, ITemplateVariable, StepTypeEnum, IPreferenceChannels, DigestTypeEnum, DigestUnitEnum, DelayTypeEnum, ActorTypeEnum } from '@novu/shared';
...
export {};
//# sourceMappingURL=create-notification-template.interface.d.ts.map