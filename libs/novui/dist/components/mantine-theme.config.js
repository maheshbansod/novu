 ...
 */
const generateMantineColorTokens = (colorFamily) => {
    return Object.keys(COLOR_PALETTE_TOKENS[colorFamily]).map((paletteNumber) => token(`colors.${colorFamily}.${paletteNumber}.dark`));
};
...
//# sourceMappingURL=mantine-theme.config.js.map