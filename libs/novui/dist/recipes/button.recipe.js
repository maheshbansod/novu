...
const SLOTS = ['root', 'inner', 'label', 'loader', 'section'];
export const BUTTON_RECIPE = defineSlotRecipe({
    ...
    variants: {
        ...
        variant: {
            filled: {
                root: Object.assign(Object.assign({}, colorPaletteGradientHorizontal), { border: '[none]' }),
                label: {
            ...
            outline: {
                ...
                label: Object.assign({}, colorPaletteGradientText),
                section: {
            ...
            transparent: {
                ...
                label: Object.assign({}, colorPaletteGradientText),
                section: Object.assign(Object.assign({}, colorPaletteGradientHorizontal), { borderRadius: '50', 
                    // required to create adequate space around an icon
                    padding: '[2px]', marginRight: '50', '& svg': {
