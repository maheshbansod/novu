...
export const getOutlineStyles = (theme) => {
    ...
    return {
        ...
        background: `${dark ? getGradient(colors.B17) : getGradient(colors.white)} padding-box, ${colors.horizontal} border-box`,
...
export default createStyles((theme, { disabled, inherit, variant, pulse }, getRef) => {
    ...
    return {
        ...
        root: Object.assign({ backgroundImage: colors.horizontal, width: inherit ? '100%' : '', [`&:not(.${loading}):disabled`]: {
                boxShadow: 'none',
            }, '&&:hover': {
                backgroundSize: '100%',
            }, '&:focus': {
